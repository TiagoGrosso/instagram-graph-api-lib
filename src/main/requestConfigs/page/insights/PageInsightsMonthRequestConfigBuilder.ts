...
/**
 * Builder for Page Insights Requests that fetch month metrics.
 *
 * @author Tiago Grosso <tiagogrosso99@gmail.com>
 * @since 0.1.0
 */

export class PageInsightsMonthRequestConfigBuilder extends AbstractPageInsightsRequestConfigBuilder {
